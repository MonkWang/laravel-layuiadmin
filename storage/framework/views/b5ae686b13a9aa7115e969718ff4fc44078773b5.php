    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <?php if(isset($guard) && $guard == 'web'): ?>
                <iframe src="<?php echo e(route('home.console')); ?>" frameborder="0" class="layadmin-iframe"></iframe>
                    <?php elseif(isset($guard) &&  $guard == 'merchant'): ?>
                    <iframe src="<?php echo e(route('merchant.home.console')); ?>" frameborder="0" class="layadmin-iframe"></iframe>
                <?php elseif(isset($guard) && $guard == 'store'): ?>
...
</html><?php /**PATH /Users/amber/Desktop/php/wjlaravel/resources/views/layouts/app.blade.php ENDPATH**/ ?>